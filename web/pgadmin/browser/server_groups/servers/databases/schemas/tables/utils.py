    ...
    * _format_args(self, arg)
    ...
    def check_precondition(f):
        ...
        def wrap(*args, **kwargs):
            ...
            if 'gpdb' == server_type and 'HAWQ' in self.manager.ver:
                server_type = 'hawq'
    ...
    def get_reverse_engineered_sql(self, did, scid, tid, main_sql, data):
        ...
        SQL = render_template("/".join(
            [self.rules_template_path, 'properties.sql']), tid=tid, servertype=servertype)
        ...
        for row in rset['rows']:
            ...
            ), rid=row['oid'], datlastsysoid=self.datlastsysoid, servertype=servertype)
