...
class PGChildModule(object):
    ...
    * BackendSupported(manager)
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.min_hawqver = 80215
        self.max_hawqver = 1000000000
    ...
    def BackendSupported(self, manager, **kwargs):
        ...
        if self.server_type is None or manager.server_type in self.server_type:
            ...
            if 'HAWQ' in manager.ver:
                min_server_version = self.min_hawqver
                max_server_version = self.max_hawqver
            else:
...
class PGChildNodeView(NodeView):
    def children(self, **kwargs):
        ...
        returnnodes = []
        if 'HAWQ' in manager.ver:
            exceptnodes = ['pgadmin.node.event_trigger',
        ...
        return make_json_response(
            data=sorted(
                returnnodes, key=lambda c: c['label']
            )
        )
